<form id="criarVeiculoForm"  action="{{ url('/perfil/store_veiculo') }}" method="POST" >
	@csrf <!-- {{ csrf_field() }} -->
	...
	<div class="row">
		...
		<div class="col">
			...
			placeholder="Digitar VIN. Por exemplo: QWE123ZXZCASD1231" title ="17 caracteres." minlength="17" maxlength="17" required="required" aria-describedby="codVinHelp">
		...
		<div class="col">
			...
			placeholder="Por exemplo: ASD-2021 ou por exemplo: ASD2021" title ="" minlength="7" maxlength="8" required="required" aria-describedby="nroPlacaHelp">
	...
	<div class="row">
		<div class="col">
			...
			placeholder="Digitar número do marca do veículo " title ="" minlength="3" maxlength="50" required="required" aria-describedby="marcaHelp">
		...
		<div class="col">
			...
			placeholder="Digitar modelo placa do veículo " title ="" minlength="3" maxlength="50" required="required" aria-describedby="marcaHelp">
	...
	<div class="row">
		...
		<div class="col">
			...
			placeholder="Digitar versao do veículo " title ="" minlength="3" maxlength="20" required="required" aria-describedby="versaoHelp">
		...
		<div class="col">
			...
			placeholder="Digitar cor do veículo" title ="" minlength="3" maxlength="20" required="required" aria-describedby="corCorpoHelp">
		...
		<div class="col">
			...
			placeholder="Por exemplo: 21 ou 2021" title ="" minlength="2" maxlength="4" required="required" aria-describedby="anoHelp">
